  ...
  return (
    <div className="min-h-screen bg-dark-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand-900/30 rounded-full blur-[100px]"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-brand-600/20 rounded-full blur-[100px]"></div>
      </div>
      ...
      <div className="w-full max-w-md bg-dark-card border border-dark-border rounded-2xl shadow-2xl p-8 z-10 backdrop-blur-sm bg-opacity-80">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-2">Join {APP_NAME} and start creating</p>
        </div>
